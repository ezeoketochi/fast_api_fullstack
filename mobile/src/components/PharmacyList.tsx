...
interface PharmacyListProps {
    /** Array of pharmacies to display */
    pharmacies: Pharmacy[];
    ...
    if (pharmacies.length === 0) {
        return (
            <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No pharmacies yet. Create one above!</Text>
            </View>
        );
    }
                ...
                <View key={pharmacy.id}>
                    ...
                    <View style={styles.userCard}>
                        ...
                        <View style={styles.userInfo}>
                            <Text style={styles.userName}>{pharmacy.name}</Text>
                            <Text style={styles.userEmail}>{pharmacy.address}</Text>
                            <Text style={styles.userEmail}>{pharmacy.phone_number}</Text>
                        ...
                        <View style={styles.buttonGroup}>
                            ...
                            <Pressable
                                ...
                                onPress={() => onEdit(pharmacy)} // Pass full pharmacy object
                                disabled={loading}
                            >
                            ...
                            <Pressable
                                ...
                                onPress={() => onDelete(pharmacy.id)} // Pass just the ID
                                disabled={loading}
                            >
