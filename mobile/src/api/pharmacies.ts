...
import type { Pharmacy, PharmacyCreate, User } from "../types";
 ...
 */
const API_BASE = `${process.env.EXPO_PUBLIC_API_BASE_URL}/api/pharmacies`;
 ...
 */
export const createPharmacy = async (user: PharmacyCreate): Promise<Pharmacy> => {
  // NOTE: Trailing slash is REQUIRED! FastAPI redirects /api/pharmacies → /api/pharmacies/
